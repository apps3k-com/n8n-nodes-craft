...
- Search apps3k-memory before any work; read referenced Plane work items.
...
- Conventional Commits; the PR links its Plane Craft Nodes issue (direct URL and CRNO-N).
